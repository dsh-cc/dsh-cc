...
- Slice 1 (exit resume tip) shipped in this PR.
- Slice 2 (the resumed-cwd guard) shipped separately via PR #58 and was
  later extended by PR #62; it is no longer covered here. This document now
  covers the exit resume tip only.
